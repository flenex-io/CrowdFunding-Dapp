...
contract crowdfunding {
    ...
    function createNewProject(
        ...
        string memory _cid  // Optional parameter for the image CID
    ) external {
        projects.push(
            Project({
                ...
                cid: _cid,  // Set the CID to the provided value or an empty string if not provided
    ...
    // Takes an array of indexes as a parameter
    // Returns an array of metadata of projects at respective indexes
    ...
    // Returns an array of indexes of projects created by a creator
    ...
    // Returns an array of details of fundings by the contributor
    ...
    // Helper function adds details of funding to the project in the projects array
    ...
    // Funds the project at the given index
    ...
    function getContributorIndex(
        uint256 _index
    ) internal view validIndex(_index) returns (int256) {
